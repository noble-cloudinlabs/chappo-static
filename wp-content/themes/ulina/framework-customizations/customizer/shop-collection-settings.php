...
$fields[] = array(
    'type'        => 'custom',
	'settings'    => 'shop_collection_custom_01',
	'label'       => FALSE,
	'section'     => 'shop_collection_settings',
	'default'     => '<div class="customizer_label">'.esc_html__('Banner Settings', 'ulina').'</div>',
);
$fields[]= array(
    'type'        => 'switch',
	'settings'    => 'shop_collection_is_banner',
...
$fields[] = array(
    'type'        => 'background',
	'settings'    => 'shop_collection_banner_bg',
	'label'       => esc_html__( 'Banner Background', 'ulina' ),
	'description' => esc_html__( 'Setup you shop collection page banner BG.', 'ulina' ),
	'section'     => 'shop_collection_settings',
	'default'     => [
		'background-color'      => '',
		'background-image'      => '',
	...
	'output'      => [
		[
			'element' => '.pageBannerSection.shopCollPageBanner',
		]
	],
    'active_callback' => [
            [
                    'setting'  => 'shop_collection_is_banner',
                    'operator' => '==',
                    'value'    => true,
            ]
    ],
...
$fields[] = array(
    'type'          => 'text',
	'settings'      => 'shop_collection_banner_title',
    ...
    'js_vars'       => array(
        array(
            'element'  => '.pageBannerSection.shopCollPageBanner .pageBannerContent h2',
            'function' => 'html'
        ),
    ),
    'active_callback' => [
...
$fields[]= array(
    'type'        => 'switch',
	'settings'    => 'shop_collection_is_breadcrumb',
...
$fields[]= array(
	...
	'settings'    => 'shop_collection_banner_alignment',
...
$fields[]= array(
	'type'		  => 'dimensions',
	'settings'    => 'shop_collection_banner_padding',
	...
	'output'      => [
		[
			'element' => '.pageBannerSection.shopCollPageBanner .pageBannerContent',
		],
	],
	'default'     => [
			'padding-top'    => '',
...
$fields[]= array(
    'type'        => 'color',
    'settings'    => 'shop_collection_banner_title_color',
...
$fields[]= array(
    'type'        => 'color',
    'settings'    => 'shop_collection_banner_breadcrumb_color',
	...
	'output'      => [
		[
			'element' => '.pageBannerSection.shopCollPageBanner .pageBannerContent .pageBannerPath',
			'property' => 'color'
		],
	],
    'active_callback' => [
...
$fields[]= array(
    'type'        => 'color',
    'settings'    => 'shop_collection_banner_breadcrumb_link_color_hover',
	...
	'output'      => [
		[
			'element' => '.pageBannerSection.shopCollPageBanner .pageBannerContent .pageBannerPath a:hover',
			'property' => 'color'
		],
	],
    'active_callback' => [
...
$fields[] = array(
		'type'        => 'custom',
		'settings'    => 'shop_collection_custom_02',
		'label'       => FALSE,
		'section'     => 'shop_collection_settings',
...
$fields[] = array(
        'type'        => 'select',
        'settings'    => 'shop_collection_sidebar',
...
$fields[] = array(
        'type'        => 'select',
        'settings'    => 'shop_collection_col_xl',
...
$fields[] = array(
        'type'        => 'select',
        'settings'    => 'shop_collection_col_lg',
...
$fields[] = array(
        'type'        => 'select',
        'settings'    => 'shop_collection_col_md',
...
$fields[] = array(
        'type'        => 'select',
        'settings'    => 'shop_collection_col_sm',
...
$fields[]= array(
		'type'        => 'switch',
		'settings'    => 'shop_collection_is_count',
...
$fields[]= array(
		'type'        => 'switch',
		'settings'    => 'shop_collection_is_sort',
...
$fields[]= array(
		'type'        => 'switch',
		'settings'    => 'shop_collection_is_view_toggler',
...
$fields[] = array(
		'type'        => 'select',
		'settings'    => 'shop_collection_default_view',
		...
		'active_callback' => [
				[
						'setting'  => 'shop_collection_is_view_toggler',
						'operator' => '==',
						'value'    => true,
				]
		],
...
$fields[] = array(
		'type'        => 'number',
		'settings'    => 'shop_collection_thumb_width',
...
$fields[] = array(
		'type'        => 'number',
		'settings'    => 'shop_collection_thumb_height',
...
$fields[] = array(
		'type'        => 'number',
		'settings'    => 'shop_collection_list_thumb_width',
...
$fields[] = array(
		'type'        => 'number',
		'settings'    => 'shop_collection_list_thumb_height',
...
$fields[]= array(
		'type'        => 'switch',
		'settings'    => 'shop_collection_is_flashlabels',
...
$fields[]= array(
		'type'        => 'switch',
		'settings'    => 'shop_collection_is_wishlist',
...
$fields[]= array(
        'type'        => 'switch',
		'settings'    => 'shop_collection_is_quickview',
...
$fields[]= array(
        'type'        => 'switch',
		'settings'    => 'shop_collection_is_rating_count',
...
$fields[] = array(
        'type'          => 'text',
	'settings'      => 'shop_collection_review_label',
	'label'         => esc_html__('Rating Label', 'ulina'),
	'section'       => 'shop_collection_settings',
	'default'       => esc_html__('Reviews', 'ulina'),
        'active_callback' => [
                [
                        'setting'  => 'shop_collection_is_rating_count',
                        'operator' => '==',
                        'value'    => true,
                ]
        ],
...
$fields[] = array(
		'type'        => 'select',
		'settings'    => 'shop_collection_pagination_type',
...
$fields[] = array(
        'type'          => 'text',
	'settings'      => 'shop_collection_ajax_btn_label',
	'label'         => esc_html__('Ajax Label', 'ulina'),
	'section'       => 'shop_collection_settings',
	'default'       => esc_html__('Load More', 'ulina'),
        'active_callback' => [
                [
                        'setting'  => 'shop_collection_pagination_type',
                        'operator' => '==',
                        'value'    => '2',
                ]
        ],
...
$fields[] = array(
		'type'        => 'radio-buttonset',
		'settings'    => 'shop_collection_pagi_align',
...
$fields[] = array(
		'type'        => 'slider',
		'settings'    => 'shop_collection_paging_margin',
...
$fields[] = array(
		'type'        => 'custom',
		'settings'    => 'shop_collection_custom_03',
		'label'       => FALSE,
		'section'     => 'shop_collection_settings',
...
$fields[] = array(
	...
	'section'       => 'shop_collection_settings',
	'settings'      => 'shop_collection_top_bloks',
	'row_label'     => [
			'type'  => 'text',
...
$fields[] = array(
		...
		'section'       => 'shop_collection_settings',
		'settings'      => 'shop_collection_bottom_bloks',
		'row_label'     => [
			'type'  => 'text',
