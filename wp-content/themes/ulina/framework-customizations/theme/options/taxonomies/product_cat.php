<?php
$options = array(
        'shop_cats_sec_heading_01'                    => array(
                'type'  => 'html',
                'value' => 'h1',
                'label' => ' ',
                'html'  => '<div class="customizer_label">'.esc_html__('Category Banner Settings', 'ulina').'</div>',
        ),
        'shop_cats_is_settings'                    => array(
                ...
                'value'        => '2',
                'desc'         => esc_html__('Enable bellow settings for this category banner.', 'ulina'),
        ),
        'shop_cats_is_banner'                    => array(
                ...
                'value'        => '1',
                'desc'         => esc_html__('Do you want to hide banner only for this category? Then please turn it to Hide.', 'ulina'),
        ),
        ...
        'shop_cats_is_breadcrumb'   => array(
                ...
                'value'        => '1',
                'desc'         => esc_html__('Do you want to show breadcrumb on category banner?', 'ulina'),
        ),
        ...
        'shop_cats_sec_heading_02'                    => array(
                'type'  => 'html',
                'value' => 'h1',
                'label' => ' ',
                'html'  => '<div class="customizer_label">'.esc_html__('Category Content Settings', 'ulina').'</div>',
        ),
        'shop_cats_is_content_settings'                    => array(
                ...
                'value'        => '2',
                'desc'         => esc_html__('Enable bellow settings for this category content.', 'ulina'),
        ),
        ...
        'shop_cats_is_rating_count'                    => array(
        ...
        'shop_cats_review_label'	 => array(
                'type'		 => 'text',
                'value'		 => '',
                'label'		 => esc_html__( 'Rating Label', 'ulina' ),
        ),
        'shop_cats_pagination_type'              => array(
        ...
        'shop_cats_ajax_btn_label'	 => array(
                'type'		 => 'text',
                'value'		 => '',
