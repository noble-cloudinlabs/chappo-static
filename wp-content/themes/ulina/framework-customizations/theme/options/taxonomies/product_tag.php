<?php
$options = array(
        'shop_tags_sec_heading_01'                    => array(
                'type'  => 'html',
                'value' => '',
                'label' => ' ',
                'html'  => '<div class="customizer_label">'.esc_html__('Tag Banner Settings', 'ulina').'</div>',
        ),
        'shop_tags_is_settings'                    => array(
                ...
                'value'        => '2',
                'desc'         => esc_html__('Enable bellow settings for this tag banner.', 'ulina'),
        ),
        'shop_tags_is_banner'                    => array(
                ...
                'value'        => '1',
                'desc'         => esc_html__('Do you want to hide banner only for this tag? Then please turn it to Hide.', 'ulina'),
        ),
        ...
        'shop_tags_is_breadcrumb'   => array(
                ...
                'value'        => '1',
                'desc'         => esc_html__('Do you want to show breadcrumb on tag banner?', 'ulina'),
        ),
        ...
        'shop_tags_sec_heading_02'                    => array(
                'type'  => 'html',
                'value' => '',
                'label' => ' ',
                'html'  => '<div class="customizer_label">'.esc_html__('Tag Content Settings', 'ulina').'</div>',
        ),
        'shop_tags_is_content_settings'                    => array(
                ...
                'value'        => '2',
                'desc'         => esc_html__('Enable bellow settings for this tag content.', 'ulina'),
        ),
        ...
        'shop_tags_is_rating_count'                    => array(
        ...
        'shop_tags_review_label'	 => array(
                'type'		 => 'text',
                'value'		 => '',
                'label'		 => esc_html__( 'Rating Label', 'ulina' ),
        ),
        'shop_tags_pagination_type'              => array(
        ...
        'shop_tags_ajax_btn_label'	 => array(
                'type'		 => 'text',
                'value'		 => '',
