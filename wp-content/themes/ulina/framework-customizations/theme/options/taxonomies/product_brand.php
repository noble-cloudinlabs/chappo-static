<?php
$options = array(
        'shop_brands_sec_heading_01'                    => array(
                'type'  => 'html',
                'value' => '',
                'label' => ' ',
                'html'  => '<div class="customizer_label">'.esc_html__('Brand Banner Settings', 'ulina').'</div>',
        ),
        'shop_brands_is_settings'                    => array(
                ...
                'value'        => '2',
                'desc'         => esc_html__('Enable bellow settings for this brand banner.', 'ulina'),
        ),
        'shop_brands_is_banner'                    => array(
                ...
                'value'        => '1',
                'desc'         => esc_html__('Do you want to hide banner only for this brand? Then please turn it to Hide.', 'ulina'),
        ),
        'shop_brands_banner_bg' => array(
                'type'	 => 'upload',
                'label'	 => esc_html__( 'Banner BG IMG', 'ulina' ),
                'desc'	 => esc_html__( 'Upload your page banner bg image.', 'ulina' ),
        ),
        'shop_brands_banner_bg_color'	=> array(
        ...
        'shop_brands_is_breadcrumb'   => array(
                ...
                'value'        => '1',
                'desc'         => esc_html__('Do you want to show breadcrumb on brand banner?', 'ulina'),
        ),
        'shop_brands_banner_alignment'              => array(
        ...
        'shop_brands_sec_heading_02'                    => array(
                'type'  => 'html',
                'value' => '',
                'label' => ' ',
                'html'  => '<div class="customizer_label">'.esc_html__('Brand Content Settings', 'ulina').'</div>',
        ),
        'shop_brands_is_content_settings'                    => array(
                ...
                'value'        => '2',
                'desc'         => esc_html__('Enable bellow settings for this brand content.', 'ulina'),
        ),
        'shop_brands_sidebar'              => array(
        ...
        'shop_brands_is_view_toggler'                    => array(
        ...
        'shop_brands_default_view'              => array(
        ...
        'shop_brands_thumb_height'              => array(
                'type'  => 'slider',
                'value' => '',
                'properties' => array(
                        'min' => 0,
        ...
        'shop_brands_list_thumb_width'              => array(
                'type'  => 'slider',
                'value' => '',
                'properties' => array(
                        'min' => 0,
        ...
        'shop_brands_list_thumb_height'              => array(
                'type'  => 'slider',
                'value' => '',
                'properties' => array(
                        'min' => 0,
        ...
        'shop_brands_is_flashlabels'                    => array(
        ...
        'shop_brands_is_quickview'                    => array(
        ...
        'shop_brands_is_rating_count'                    => array(
        ...
        'shop_brands_review_label'	 => array(
                'type'		 => 'text',
                'value'		 => '',
                'label'		 => esc_html__( 'Rating Label', 'ulina' ),
        ),
        'shop_brands_pagination_type'              => array(
        ...
        'shop_brands_ajax_btn_label'	 => array(
                'type'		 => 'text',
                'value'		 => '',
                'label'		 => esc_html__( 'Ajax BTN Label', 'ulina' ),
        ),
        'shop_brands_pagi_align'              => array(
        ...
        'shop_brands_bottom_bloks'                    => array(
                'type'  => 'addable-box',
                'value' => array(),
