...
if (is_tax('product_cat') && defined('FW')):
    ...
    $shop_list_thumb_width = get_theme_mod('shop_cat_list_thumb_width', 0);
    $shop_list_thumb_height = get_theme_mod('shop_cat_list_thumb_height', 0);
    ...
    if($shop_cats_is_content_settings == 1):
        ...
        $shop_cats_list_thumb_width = fw_get_db_term_option($termID, 'product_cat', 'shop_cats_list_thumb_width', 0);
        $shop_cats_list_thumb_height = fw_get_db_term_option($termID, 'product_cat', 'shop_cats_list_thumb_height', 0);
...
elseif (is_tax('product_tag') && defined('FW')):
    ...
    $shop_list_thumb_width = get_theme_mod('shop_tag_list_thumb_width', 0);
    $shop_list_thumb_height = get_theme_mod('shop_tag_list_thumb_height', 0);
    ...
    if($shop_tags_is_content_settings == 1):
        ...
        $shop_tags_list_thumb_width = fw_get_db_term_option($termID, 'product_tag', 'shop_tags_list_thumb_width', 0);
        $shop_tags_list_thumb_height = fw_get_db_term_option($termID, 'product_tag', 'shop_tags_list_thumb_height', 0);
...
elseif (is_tax('product_brand') && defined('FW')):
    ...
    $shop_list_thumb_width = get_theme_mod('shop_brand_list_thumb_width', 0);
    $shop_list_thumb_height = get_theme_mod('shop_brand_list_thumb_height', 0);
    ...
    if($shop_brands_is_content_settings == 1):
        ...
        $shop_brands_list_thumb_width = fw_get_db_term_option($termID, 'product_brand', 'shop_brands_list_thumb_width', 0);
        $shop_brands_list_thumb_height = fw_get_db_term_option($termID, 'product_brand', 'shop_brands_list_thumb_height', 0);
        ...
        $shop_list_thumb_width = ($shop_brands_list_thumb_width > 0 ? $shop_brands_list_thumb_width : $shop_list_thumb_width);
        $shop_list_thumb_height = ($shop_brands_list_thumb_height > 0 ? $shop_brands_list_thumb_height : $shop_list_thumb_height);
...
elseif (is_tax('product_collection') && defined('FW')):
    ...
    $shop_list_thumb_width = get_theme_mod('shop_collection_list_thumb_width', 0);
    $shop_list_thumb_height = get_theme_mod('shop_collection_list_thumb_height', 0);
    ...
    if($shop_collections_is_content_settings == 1):
        ...
        $shop_collections_list_thumb_width = fw_get_db_term_option($termID, 'product_collection', 'shop_collections_list_thumb_width', 0);
        $shop_collections_list_thumb_height = fw_get_db_term_option($termID, 'product_collection', 'shop_collections_list_thumb_height', 0);
        ...
        $shop_list_thumb_width = ($shop_collections_list_thumb_width > 0 ? $shop_collections_list_thumb_width : $shop_list_thumb_width);
        $shop_list_thumb_height = ($shop_collections_list_thumb_height > 0 ? $shop_collections_list_thumb_height : $shop_list_thumb_height);
...
$w = ($shop_list_thumb_width > 0 ? $shop_list_thumb_width : 312);
$h = ($shop_list_thumb_height > 0 ? $shop_list_thumb_height : 360);
...
$contentLimit = ($shop_sidebar != 1 && is_active_sidebar('sidebar-3') ? 54 : 113);
...
<div class="col-lg-12 col-xl-6 ulinaProductListCols">
