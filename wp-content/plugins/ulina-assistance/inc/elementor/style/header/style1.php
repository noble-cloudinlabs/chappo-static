            ...
            <div class="col-lg-12">
                <div class="headerInner01">
                    ...
                    <div class="accessNav">
                        ...
                        <div class="anSocial">
                            <div class="ansWrap">
                                <?php foreach ($s_list as $sl):
                                $s2_icons = (isset($sl['s_icons']) ? $sl['s_icons'] : '');
                                $s2_url   = (isset($sl['s_url']['url']) ? $sl['s_url']['url'] : '');
                                $s2_color = (isset($sl['s_color']) ? $sl['s_color'] : '');
                            ...
                            <a class="tog" href="javascript:void(0);"><i class="ulina-share-alt"></i></a>
                        </div>
                        <?php endif; ?>
                        <?php if($is_language2 == 'yes' || $is_currency2 == 'yes'): ?>
                        <div class="anSelects">
                            <?php if($is_language == 'yes' && shortcode_exists('wpml_language_switcher')): ?>
                            <div class="anSelect">
                                <?php echo do_shortcode('[wpml_language_switcher type="widget" flags="'.$is_language_flag.'"][/wpml_language_switcher]'); ?>
                            </div>
                            <?php endif; ?>
                            <?php if($is_currency == 'yes' && shortcode_exists('currency_switcher')): ?>
                            <div class="anSelect">
                        ...
                        <?php if ($is_info_boxs == 'yes'): ?>
                            <div class="anSupport">
                                ...
                                <?php endif; ?>
                                <?php if ($i_labels != ''): ?><h3><?php echo wp_kses_post($i_labels); ?></h3><?php endif; ?>
                                <?php if ($i_values != ''): ?><h3><?php echo wp_kses_post($i_values); ?></h3><?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
